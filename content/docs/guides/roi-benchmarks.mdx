...
For single-operation reads, GitHub's architecture wins by ~1.1x. For multi-file writes, Coregit's atomic API wins by 2-3x — the overhead of distributed components is amortized across one call instead of thirteen.
